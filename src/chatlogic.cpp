...
ChatLogic::ChatLogic()
{
    ...
    // OLD: _chatBot = new ChatBot("../images/chatbot.png");

    // add pointer to chatlogic so that chatbot answers can be passed on to the GUI
    // OLD: _chatBot->SetChatLogicHandle(this);
...
ChatLogic::~ChatLogic()
{
    ...
    // delete all nodes
    // OLD: for (auto it = std::begin(_nodes); it != std::end(_nodes); ++it)
    // OLD: {
    // OLD:     delete *it;
    // OLD: }

    // delete all edges
    // OLD: for (auto it = std::begin(_edges); it != std::end(_edges); ++it)
    // OLD: {
    // OLD:     delete *it;
    // OLD: }
